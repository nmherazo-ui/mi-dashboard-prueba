# ============================================================
# Lasso MultiOutput H10 + timeseries-cv GroupKFold (train/validation)
...
# - Modelo: Pipeline(StandardScaler + Lasso).
# - Lasso acepta salida múltiple directamente en scikit-learn.
...
# Archivos tabulares
archivo_resultados = carpeta_salida / "resultados_lasso_multioutput_h10_timeseries_cv_bds.csv"
archivo_resumen = carpeta_salida / "resumen_lasso_multioutput_h10_timeseries_cv_bds.csv"
archivo_test_final = carpeta_salida / "test_final_externo_lasso_multioutput_h10_calamar.csv"
archivo_metricas_horizontes = carpeta_salida / "metricas_horizontes_1_5_10_lasso_multioutput_h10.csv"

# Figuras
archivo_figura_test = carpeta_salida / "lasso_multioutput_h10_test_final_externo.png"
archivo_acf_residuos = carpeta_salida / "acf_residuos_lasso_multioutput_h10_test_externo.png"
archivo_hist_residuos = carpeta_salida / "histograma_residuos_lasso_multioutput_h10_test_externo.png"

# Modelo y metadata
archivo_modelo = carpeta_salida / "modelo_lasso_multioutput_h10_calamar.joblib"
archivo_metadata = carpeta_salida / "metadata_modelo_lasso_multioutput_h10_calamar.json"
...
# Grid de Lasso
# Si demora muy poco, puedes ampliar este grid.
# Si no converge, aumenta max_iter en crear_pipeline().
param_grid = {
...
def crear_pipeline():
    ...
    - Lasso se entrena sobre la salida múltiple H10.
    """
    pipe = Pipeline([
...
# ============================================================
# 5. Validación cruzada temporal con Lasso MultiOutput
# ============================================================
...
modelo_final.set_params(lasso__alpha=best_alpha)
...
plt.title("Histograma de residuos - Lasso MultiOutput H10 en test externo")
...
if max_lags >= 1:
    ...
    ax.set_title("ACF de residuos - Lasso MultiOutput H10 en test externo")
...
plt.title(
    f"Lasso MultiOutput - Test externo final H10 | "
